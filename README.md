...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/chartpress-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13771&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/chartpress-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `chartpress` can be installed with:

```
conda install chartpress
```

It is possible to list all of the versions of `chartpress` available on your platform with:
